...
class TestTzinfoParser:
    ...
    def test_rejects_invalid_numeric_timezone_offsets(self):
        for value in ["+01:60", "+24:00", "+01:00junk"]:
            with pytest.raises(ParserError):
                self.parser.parse(value)

    def test_rejects_trailing_timezone_wrapper_text(self):
        for value in ["+01:00))", "+01:00)junk", "(UTC+01:00)junk"]:
            with pytest.raises(ParserError):
                self.parser.parse(value)
